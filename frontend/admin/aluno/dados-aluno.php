<div class="row">
    <div class="col-lg-12 col-sm-12 mb-3">
        <div class="" style="overflow: auto; overflow-x: hidden;height: 380px;">
            <div class="row mt-2">
        ...
        <button style="width: 150px;" class="float-right mt-3 btn btn-primary" data-toggle="modal"
            data-target=".editar-aluno">
