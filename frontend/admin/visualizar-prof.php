    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav nav1">
            ...
            <li class="active has-sub">
                ...
                <ul class="sub-menu">
                    <li class="active"><a href="professor"><i class="fas fa-tags"></i>Cadastrar
                            professores</a></li>
                </ul>
            </li>
            ...
            <li class=" has-sub">
                ...
                <ul class="sub-menu">
                    <li class=""><a href="aluno"><i class="fas fa-tags"></i> Cadastrar Aluno</a>
                    </li>
                </ul>
            </li>
    ...
    <div class="">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active show" id="default-tab-1">
                ...
                <img class="ml-3" width="200" height="250" src="../foto/professor/" alt="">
                <form name="wysihtml5" action="/SGN/view/prof/visualizarProf.php?professor=" enctype="multipart/form-data" method="POST">
