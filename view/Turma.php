        ...
        <ul class="nav nav1">
            ...
            <li class="active has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="active"><a href="/SGN/view/turma.php"><i class="fas fa-tags"></i> Gerir Turma</a></li>
...
<div id="content" class="content">
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item"><a href="javascript:;">Gerências Turma</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Gerências Turma</small></h1>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Gerências Turma</h4>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Adicionar Turma e Classe</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="/SGN/view/turma.php" method="POST">
                            <div class="modal-body">
                                <div style="max-width: 400px;margin: auto;display: flex;flex-direction: column;justify-content: center; align-items: center;">
            
                                    <input required type="text" name="nome_turma" class="form-control mb-3"  placeholder="Nome da Turma">
                                </div>
                            </div>
                        ...
                        <form action="/SGN/view/turma.php" method="POST">
                            <div class="modal-body">
                                <div style="max-width: 400px;margin: auto;display: flex;flex-direction: column;justify-content: center; align-items: center;">
                                    ...
                                    <input required type="text" name="update_turma" id="update_turma" class="form-control mb-3"  placeholder="Nome da Turma">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
