        ...
        <ul class="nav nav1">
            ...
            <li class="active has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="active"><a href="/SGN/view/classe.php"><i class="fas fa-tags"></i> Gerir Classe</a></li>
                </ul>
            </li>
...
<div id="content" class="content">
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item"><a href="javascript:;">Gerências Classe</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Gerências Classe</small></h1>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Gerências Classe</h4>
            ...
            <div class="modal fade" id="Inserir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="/SGN/view/classe.php" method="POST">
