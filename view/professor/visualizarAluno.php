...
<div id="content" class="content">
    ...
    <ol class="breadcrumb float-xl-right">
        <li class="breadcrumb-item"><a href="/SGN/admin/">Sala</a></li>
        <li class="breadcrumb-item"><a href="javascript:;">Perfil Aluno</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= url('visualizarAluno') ?>?aluno=<?= $data['nome_aluno']?>" enctype="multipart/form-data">
                                <div class="row">
                                    <input disabled type="hidden" value="<?= $data['id']?>" name="id">
                                    <div class="col-lg-6">
                                        <label>Nome</label>
                                        <input disabled required type="text" value="<?= $data['nome_aluno']?>" name="nome" class="form-control mb-3"
                                            placeholder="Nome do Aluno">
                                    </div>

                                    <div class="col-lg-6">
                                        <label>Classe</label>
                                        <select disabled class="form-control mb-3" name="classe" id="">
                                    ...
                                    <div class="col-lg-8">
                                        <label>Turno</label>
                                        <select disabled class="form-control mb-3" name="turno" id="">
                                    ...
                                    <div class="col-lg-4">
                                        <label>Turma</label>
                                        <select disabled class="form-control mb-3" name="turma" id="">
                                    ...
                                    <div class="col-lg-4">
                                        <label>Sala</label>
                                        <select disabled class="form-control mb-3" name="sala" id="">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select disabled class="form-control mb-3" name="curso" id="">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input disabled class="form-control" value="<?= $data['nome_responsavel']?>" type="text" name="responsavel" id=""
                                            placeholder="Responsável">
                                    </div>

                                    <div class="col-lg-4">
                                        <label for="">Email</label>
                                        <input disabled class="form-control" value="<?= $data['email']?>" type="email" name="email" id="" placeholder="Email">
                                    </div>

                                    <div class="col-lg-4">
                                        <label for="">Sexo</label>
                                        <select disabled class="form-control mb-3" name="sexo" id="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea disabled name="desc" class="form-control" rows="5"><?= $data['descricao']?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card card-profile">
                        <div class="card-avatar mt-3">
                            <a href="javascript:;">
                                <img style="border-radius: 50%;" width="180" class="d-flex m-auto mt-3 img" src="../admin/foto/aluno/<?= $data['foto']?>" />
                            </a>
                        </div>
                        <div class="card-body">
