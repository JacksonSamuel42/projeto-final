...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Gerir Disciplina</small></h1>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Gerir Disciplina</h4>
            ...
            <div class="modal fade" id="Inserir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="/SGN/view/disciplina.php" method="POST">
                    ...
                    <?php
                        foreach ($data as $row) {?>
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <!-- <a class="updatebtn btn btn-primary text-white" href="/SGN/view/disciplina.php?id=<?= $row['id']?>">Editar</a> -->
                                    ...
                                    <!-- <a data-toggle="modal" data-target="#delete" class="text-white btn btn-danger" href="/SGN/view/disciplina.php?id=<?= $row['id']?>">Eliminar</a> -->
                                </td>
                            </tr>
                        <?php
                        }
