    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav nav1">
            ...
            <li class="has-sub">
                ...
                <ul class="sub-menu">
                    <li class="active"><a href="/SGN/view/prof/professor.php"><i class="fas fa-tags"></i>Cadastrar
                        professores</a></li>
                </ul>
            </li>
            ...
            <li class="has-sub">
                ...
                <ul class="sub-menu">
                    <li class=""><a href="/SGN/view/sala.php"><i class="fas fa-tags"></i> Gerir Disciplinas</a>
                    </li>
                </ul>
            </li>
            ...
            <div class="modal fade" id="Inserir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form name="wysihtml5" action="/SGN/view/aluno/aluno.php" enctype="multipart/form-data"
                            method="POST">
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="/SGN/view/aluno/aluno.php" method="POST">
                <div class="modal-body">
                    <div
